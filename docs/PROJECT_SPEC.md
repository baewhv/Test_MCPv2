...
- **GitHub Repository Name**: `Test_MCPv2`
- **GitHub Repository URL**: `https://github.com/baewhv/Test_MCPv2`
- **Default Integration Branch**: `develop`
- **Release Branch**: `main`
- **Worktree Parent Directory**: `../Test_MCPv2_worktrees`
...
- **Core Loop Test Scene**: `Assets/Scenes/MainGameScene.unity`
